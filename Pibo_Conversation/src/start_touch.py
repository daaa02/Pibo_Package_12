    ...
    if result == "touch":
        ...
        if count >=1 :
            ...
            if "소개" in answer[0][1] or "반가" in answer[0][1]:
                # os.system('python3 /home/pi/Pibo_Package_12/Pibo_Conversation/src/greeting.py')
                break
            
            if "헤어" in answer[0][1]:
                # os.system('python3 /home/pi/Pibo_Package_12/Pibo_Conversation/src/goodbye.py') 
                break
...
os.system('python3 /home/pi/Pibo_Package_12/Pibo_Conversation/src/schedule_run.py')
