...
from Pibo_Package_12.Pibo_Conversation.data.text_to_speech import TextToSpeech, text_to_speech
from Pibo_Package_12.Pibo_Conversation.src.drive_upload import drive_upload
...
class RunSchedule():
    ...
    def __init__(self):
        self.path = '/home/pi/Pibo_Package_12'
        self.completion = int
        self.act = ''
    ...
    def day(self):
        ...
        try:
            ...
            logfile = f'(P03)_{datetime.now().strftime("%m%d_%H%M")}.txt'   #('P<PACKAGE_NUMBER>_DATE.txt')   
            ...
            if self.completion >= 12:
                ...
                subprocess.run(['python3 /home/pi/Pibo_Package_12/Pibo_Conversation/src/start_touch.py'], shell=True)
