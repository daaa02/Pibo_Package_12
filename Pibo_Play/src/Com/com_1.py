...
sys.path.append('/home/pi/Pibo_Package_12/Pibo_Play/')
...
class Com():
    ...
    def com_1(self):
        ...
        while True:
            time.sleep(10) 
            audio.audio_play(filename="/home/pi/Pibo_Package_12/Pibo_Play/data/behavior/audio/sound_standing.mp3", volume=-2000, background=False)
